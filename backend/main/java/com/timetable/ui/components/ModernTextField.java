...
/**
 * Custom modern text field with rounded corners, custom placeholders, and indigo glowing borders on focus.
 */
public class ModernTextField extends JTextField {
    ...
    private void initComponent() {
        ...
        // Add padding so text doesn't touch the borders
